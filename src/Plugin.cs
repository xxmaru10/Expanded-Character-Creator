...
namespace CustomPartsMod
{
    ...
    /// </summary>
    [BepInPlugin(Guid, "Custom Body Parts", "0.1.0")]
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            DefaultScale = Config.Bind(
                ...
                "(independente de o modelo vir minusculo ou gigante). Ex.: 1 = ~1 unidade; 0.5 = metade.");
            ...
            Log.LogInfo("CustomPartsMod v0.1.0 carregado. Patches aplicados.");
        }
    }
}
